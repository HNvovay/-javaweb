...
<div class="pop">
    ...
    <form action="ElectricityServlet?Electricity=updatecharge" method="post">
	    <div class="pop-content">
	        ...
	        <div class="pop-content-right">
				...
				<p  style="position: absolute;left:100px;top:200px;font-size: 20px;" >请输入新的价格: &nbsp <input style="font-size:20px;" type="text" name="eleCharge"  /></p>			
	        </div>
	    </div>
	    <div class="pop-foot">
     ...
     <!-- 查询 -->   
         <div class="search-wrap">
            <div class="search-content">
                <form action="ContractServlet?electricity=1" method="post">
        ...
        <div class="result-wrap">
            <form  action="ContractServlet?Electricity=alldelete" name="myform" id="myform" method="post">
                ...
                <div class="result-title">
                    <div class="result-list">
                    				<%Connection  conn1=new ConnectDB().getConn();
                                  	...
                                  	if(rs1.next()){%>
                        <span>当前价格：<%=rs1.getFloat("eleCharge")%> 元/度 &nbsp &nbsp &nbsp</span>
                        <%}
                                  	
                                  	}catch(SQLException e){
                                  		e.printStackTrace();
                                  	}finally{
                                  		new ConnectClose().close(conn1, pstmt1, rs1);
                                  	}
                         
                        %>
                         <a href="javascript:void(0)" class="click_pop"><i class="icon-font"></i>修改</a>
                        <a id="updateOrd" href="electricity.jsp"><i class="icon-font"></i>刷新</a>
                    </div>
                </div>
					...
					<jsp:useBean id="cdb" scope="page" class="com.util.ConnectDB"></jsp:useBean>
                       ...
                       <%
                        ...
                        <tr>              				        				
                            ...
                            <td><%=result.getInt("eleDegree") %></td>                       
                            <td>                         
                                <a class="link-del" href="UpdateEleDegree.jsp?roomID=<%=result.getString("roomID")%>&residentID=<%= result.getString("residentID")%>&eleDegree=<%=result.getInt("eleDegree") %>">修改</a>
                            </td>                    
                        </tr>
