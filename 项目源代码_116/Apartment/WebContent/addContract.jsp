...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><a href="Contract.jsp">合同管理</a><span class="crumb-step">&gt;</span><span>添加合同信息</span></div>
        </div>
                ...
                <form action="AddContractServlet" method="post" enctype="multipart/form-data" >
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <td>
                               <input class="common-text required" type="text" name="roomID" placeholder="roomID,the Number is unique and exists" required="required" size="50" />
                            </td>
                        </tr>
                            <tr>
                                <th><i class="require-red">*</i>住户ID：</th>
                                <td>
                                   <input class="common-text required" type="text" name="residentID" placeholder="such as 12" required="required" size="50" /> 
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>上传合同(img)：</th>
                                 <td><input  name="contarctImg" id="" type="file" accept="image/png, image/jpeg, image/gif, image/jpg">                                                                 </td>
