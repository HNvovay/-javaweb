...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            ...
            <!-- 修改个人信息表单 -->
                <form action="WaterServlet?roomID=<%=request.getParameter("roomID")%>&Water=waterdegree" method="post" >
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>修改吨数：</th>
                                <td><input class="common-text required" type="text" name="waterDegree" placeholder="<%=request.getParameter("waterDegree") %>" required="required" size="50" /></td>
                            </tr>   
                            <tr>
                                <th></th>
                                <td>
