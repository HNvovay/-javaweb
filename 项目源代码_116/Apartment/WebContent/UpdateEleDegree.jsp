...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span>修改电费信息</span></div>
        </div>
        <div class="result-wrap">
            ...
            <!-- 修改个人信息表单 -->
                <form action="ElectricityServlet?roomID=<%=request.getParameter("roomID")%>&Electricity=updatedegree" method="post" >
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red"></i>住户ID：</th>
                            <td>
                                <span class="res-lab"><%=request.getParameter("residentID")%></span>
                            </td>
                        </tr>
                            <tr>
                                <th><i class="require-red">*</i>公寓ID：</th>
                                <td>
                                   <span class="res-lab"><%=request.getParameter("roomID")%></span>
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>修改度数：</th>
                                <td><input class="common-text required" type="text" name="eleDegree" placeholder="<%=request.getParameter("eleDegree") %>" required="required" size="50" /></td>
                            </tr>   
                            <tr>
                                <th></th>
                                <td>
